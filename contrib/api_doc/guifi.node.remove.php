<h4 id="method_node_remove"><?php _e("guifi.node.remove")?></h4>
<p><strong><?php _e("Esborra un node (o localització) guifi.net de la xarxa.")?></strong></p>

<div class="alert">
<h6><?php _e("Vés amb compte")?></h6>
<p><?php _e("Aquesta acció no té marxa enrere, i un node esborrat deixarà de
mostrar-se a la pàgina web de guifi.net.")?></p>
</div>

<h5 id="method_node_remove_params"><?php _e("Paràmetres")?></h5>
...
<table>
	...
	<tbody>
		<tr class="required">
			<td>node_id</td>
			<td>integer</td>
			<td><?php _e("ID del node a esborrar.")?></td>
			<td></td>
		</tr>
	</tbody>
</table>